...
class Manager:
    def __init__(self):
        ...
        self.anti_conn = MongoConnector(MONGO_ADDRESS,DB_NAME,COLLECTION_ANTISEMITIC)
        self.not_anti_conn = MongoConnector(MONGO_ADDRESS,DB_NAME,COLLECTION_NOT_ANTISEMITIC)
